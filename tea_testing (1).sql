...
--
-- Host: 127.0.0.1:3388
-- Generation Time: Nov 05, 2018 at 08:22 AM
...
(1, 'NEYMON INVESTMENT LIMITED', '1715 Dar es Salaam', 'Golden Tuliip 5F Jamhuri Street', '255685639653', '685639653', 'info@neymonict.com', '1538740698logo.jpg', '', 1, '2015-08-23 14:30:58', 100, 2, '', 'http://amif.co.tz', 'TZS');
...
(82, '38', '', 4, '2018-10-30', 5000035, 'Loan Disbursed', 600000, 0, 'loan_contract.LID', 'loan_contract', 1000002, '100002', '', '', 0, 10, 1, 0, 0, 'LN1000002', 100, 0, 0, 0, '2007/2008', 0),
(83, '38', '', 4, '2018-10-30', 1030012, 'Loan Disbursed', 0, 600000, 'loan_contract.LID', 'loan_contract', 1000002, '100002', '', '', 0, 10, 3, 0, 0, 'LN1000002', 100, 0, 0, 0, '2007/2008', 0);
...
(7, 'LN1000008', 1000005, 'OUT001', 5, 6, 1, 0, 70000000, 7, 'CASH', '2017-05-17', 0, 'loan', 10200997.49, 1406982.41, 71406982.41, '2017-05-17 08:33:55', 1, 0, 0, '', 0, 0, 100, '', 0, 100000000, 1, 1, 'Days', 1, 100000000, '2017-05-17'),
...
(16, 'LN1000002', '2018-10-30', 600000, ' jhnkjnkjn', 'CASH', '', 2, '2018-10-30 08:40:40', 100);
...
--
-- Dumping data for table `loan_contract_guarantor`
--

INSERT INTO `loan_contract_guarantor` (`id`, `LID`, `name`, `mobile`, `email`, `declaration`, `relationship`, `file`, `photo`, `request`, `request_status`, `PIN`) VALUES
(1, 'LN1000008', 'Hemedi', '255712765538', 'info@tea.com', 'dssd', 'father', '', '', 0, 0, 100),
(2, 'LN1000008', 'Hemedi', '255712765538', 'info@tea.com', 'mksd ckd', 'father', '1540817492bot.png', '1540817492cbe.png', 0, 0, 100),
(3, 'LN1000008', 'yona', '255712765538', 'info@tea.com', 'hjjkjk', 'ndabila', '', '', 0, 0, 100);
...
(2, 'LN1000008', 'kdalndakadda', '1540817668cbe.jpg', 100),
(3, 'LN1000008', 'jc cdj cjkdsa cadskcdsc', '1540822472mtn.png', 100),
(4, 'LN1000008', 'jc cdj cjkdsa cadskcdsc', '1540822493mtn.png', 100);
...
--
-- Table structure for table `neymon_loan`
--

CREATE TABLE `neymon_loan` (
  `id` int(11) NOT NULL,
  `loan_id` varchar(20) NOT NULL,
  `user_id` varchar(60) NOT NULL,
  `loan_amount` double NOT NULL,
  `loan_period` int(11) NOT NULL,
  `loan_period_mark` varchar(10) NOT NULL,
  `account_type` varchar(30) NOT NULL,
  `amount_by_word` text NOT NULL,
  `loan_rate` int(11) NOT NULL,
  `loan_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `loan_deadline` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `loan_amount_rate` double NOT NULL,
  `loan_amount_total` double NOT NULL,
  `loan_payed` double NOT NULL,
  `installment_payed` int(11) NOT NULL,
  `PIN` varchar(4) NOT NULL DEFAULT '100'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `neymon_loan`
--

INSERT INTO `neymon_loan` (`id`, `loan_id`, `user_id`, `loan_amount`, `loan_period`, `loan_period_mark`, `account_type`, `amount_by_word`, `loan_rate`, `loan_date`, `loan_deadline`, `loan_amount_rate`, `loan_amount_total`, `loan_payed`, `installment_payed`, `PIN`) VALUES
(1, 'LN10000001', '', 40000000, 6, 'Monthly', 'M-Pesa', '  forty milion', 10, '2018-10-24 12:16:03', '0000-00-00 00:00:00', 4000000, 44000000, 0, 0, '100'),
(2, 'LN10000002', '', 40000000, 6, 'Monthly', 'M-Pesa', '  forty milion', 10, '2018-10-24 12:17:16', '0000-00-00 00:00:00', 4000000, 44000000, 0, 0, '100'),
(3, 'LN10000003', '1000006', 40000000, 6, 'Monthly', 'M-Pesa', '  forty milion', 10, '2018-11-01 13:07:42', '0000-00-00 00:00:00', 4000000, 44000000, 0, 0, '100'),
(4, 'LN10000004', '', 40000000, 6, 'Monthly', 'M-Pesa', '  forty milion', 10, '2018-10-24 12:20:33', '0000-00-00 00:00:00', 4000000, 44000000, 0, 0, '100'),
(5, 'LN10000005', '1000006', 40000000, 6, 'Monthly', 'M-Pesa', '  forty milion', 10, '2018-11-01 13:07:30', '0000-00-00 00:00:00', 4000000, 44000000, 0, 0, '100'),
(6, 'LN10000006', '1000006', 40000000, 6, 'Monthly', 'M-Pesa', '  forty milion', 10, '2018-10-24 12:25:46', '0000-00-00 00:00:00', 4000000, 44000000, 0, 0, '100'),
(7, 'LN10000007', '1000006', 600000, 3, 'weeks', 'M-Pesa', 'sixty hundred thousand', 20, '2018-10-24 12:46:34', '2018-11-13 21:00:00', 120000, 720000, 0, 0, '100'),
(8, 'LN10000008', '1000002', 600000, 3, 'months', 'M-Pesa', '  hjhjbhj', 20, '2018-10-29 10:50:20', '2019-01-28 21:00:00', 120000, 720000, 0, 0, '100'),
(9, 'LN10000009', '1000004', 600000, 3, 'months', 'M-Pesa', 'kjkn', 10, '2018-10-29 10:52:52', '2019-01-28 21:00:00', 60000, 660000, 0, 0, '100'),
(10, 'LN10000010', '1000006', 600000, 3, 'months', 'M-Pesa', '  vfmfmmfkv', 20, '2018-10-29 12:03:42', '2019-01-28 21:00:00', 120000, 720000, 0, 0, '100');

-- --------------------------------------------------------

--
-- Table structure for table `neymon_loan_details`
--

CREATE TABLE `neymon_loan_details` (
  `details_id` int(11) NOT NULL,
  `dloan_no` varchar(20) NOT NULL,
  `grace_period` int(11) NOT NULL,
  `grace_period_mark` varchar(10) NOT NULL,
  `penalty` int(11) NOT NULL,
  `penalty_time` int(11) NOT NULL,
  `penalty_mark` varchar(10) NOT NULL,
  `dloan_purpose` text NOT NULL,
  `created_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `d_loan_status` varchar(14) NOT NULL COMMENT '1. approved. 2. new 3. accepted, 4. payed, 5 rejected',
  `edited` int(11) NOT NULL DEFAULT '1' COMMENT '1. can edited 0. can not edited',
  `evaluated` int(11) NOT NULL DEFAULT '1' COMMENT '1. pass evaluation, 0. not pass',
  `disburse` int(11) NOT NULL COMMENT '1. disbarse 0 . not',
  `push_to_ovulation` int(11) NOT NULL,
  `original_loan_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `calculation` text NOT NULL,
  `id_prepared` varchar(20) NOT NULL,
  `id_accepted` varchar(20) NOT NULL,
  `id_hidhini` varchar(20) NOT NULL,
  `activities` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `neymon_loan_details`
--

INSERT INTO `neymon_loan_details` (`details_id`, `dloan_no`, `grace_period`, `grace_period_mark`, `penalty`, `penalty_time`, `penalty_mark`, `dloan_purpose`, `created_on`, `d_loan_status`, `edited`, `evaluated`, `disburse`, `push_to_ovulation`, `original_loan_date`, `calculation`, `id_prepared`, `id_accepted`, `id_hidhini`, `activities`) VALUES
(1, 'LN10000002', 4, 'days', 1, 1, 'days', '  kkk k', '0000-00-00 00:00:00', '0', 1, 0, 0, 0, '0000-00-00 00:00:00', '[{\"month\":\"October\",\"payed\":0,\"principal\":\"40000000\",\"principle_payment\":6666666.666666667,\"interest\":4000000,\"month_pay\":10666666.666666668,\"month_remain_balance\":-10666666.666666668,\"outstanding\":44000000},{\"month\":\"October\",\"payed\":0,\"principal\":44000000,\"principle_payment\":6666666.666666667,\"interest\":4400000,\"month_pay\":11066666.666666668,\"month_remain_balance\":-11066666.666666668,\"outstanding\":48400000},{\"month\":\"October\",\"payed\":0,\"principal\":48400000,\"principle_payment\":6666666.666666667,\"interest\":4840000,\"month_pay\":11506666.666666668,\"month_remain_balance\":-11506666.666666668,\"outstanding\":53240000},{\"month\":\"October\",\"payed\":0,\"principal\":53240000,\"principle_payment\":6666666.666666667,\"interest\":5324000,\"month_pay\":11990666.666666668,\"month_remain_balance\":-11990666.666666668,\"outstanding\":58564000},{\"month\":\"October\",\"payed\":0,\"principal\":58564000,\"principle_payment\":6666666.666666667,\"interest\":5856400,\"month_pay\":12523066.666666668,\"month_remain_balance\":-12523066.666666668,\"outstanding\":64420400},{\"month\":\"October\",\"payed\":0,\"principal\":64420400,\"principle_payment\":6666666.666666667,\"interest\":6442040,\"month_pay\":13108706.666666668,\"month_remain_balance\":-13108706.666666668,\"outstanding\":70862440}]', '2', '', '', '{\"user\":\"2\",\"action_time\":\"2018-10-24 15:17:16\",\"performed\":\"Created\"}'),
(2, 'LN10000003', 4, 'days', 1, 1, 'days', '  kkk k', '0000-00-00 00:00:00', 'NEW', 1, 0, 0, 0, '0000-00-00 00:00:00', '[{\"month\":\"October\",\"payed\":0,\"principal\":\"40000000\",\"principle_payment\":6666666.666666667,\"interest\":4000000,\"month_pay\":10666666.666666668,\"month_remain_balance\":-10666666.666666668,\"outstanding\":44000000},{\"month\":\"October\",\"payed\":0,\"principal\":44000000,\"principle_payment\":6666666.666666667,\"interest\":4400000,\"month_pay\":11066666.666666668,\"month_remain_balance\":-11066666.666666668,\"outstanding\":48400000},{\"month\":\"October\",\"payed\":0,\"principal\":48400000,\"principle_payment\":6666666.666666667,\"interest\":4840000,\"month_pay\":11506666.666666668,\"month_remain_balance\":-11506666.666666668,\"outstanding\":53240000},{\"month\":\"October\",\"payed\":0,\"principal\":53240000,\"principle_payment\":6666666.666666667,\"interest\":5324000,\"month_pay\":11990666.666666668,\"month_remain_balance\":-11990666.666666668,\"outstanding\":58564000},{\"month\":\"October\",\"payed\":0,\"principal\":58564000,\"principle_payment\":6666666.666666667,\"interest\":5856400,\"month_pay\":12523066.666666668,\"month_remain_balance\":-12523066.666666668,\"outstanding\":64420400},{\"month\":\"October\",\"payed\":0,\"principal\":64420400,\"principle_payment\":6666666.666666667,\"interest\":6442040,\"month_pay\":13108706.666666668,\"month_remain_balance\":-13108706.666666668,\"outstanding\":70862440}]', '2', '', '', '{\"user\":\"2\",\"action_time\":\"2018-10-24 15:20:05\",\"performed\":\"Created\"}'),
(3, 'LN10000004', 4, 'days', 1, 1, 'days', '  kkk k', '0000-00-00 00:00:00', 'NEW', 1, 1, 0, 0, '0000-00-00 00:00:00', '[{\"month\":\"October\",\"payed\":0,\"principal\":\"40000000\",\"principle_payment\":6666666.666666667,\"interest\":4000000,\"month_pay\":10666666.666666668,\"month_remain_balance\":-10666666.666666668,\"outstanding\":44000000},{\"month\":\"October\",\"payed\":0,\"principal\":44000000,\"principle_payment\":6666666.666666667,\"interest\":4400000,\"month_pay\":11066666.666666668,\"month_remain_balance\":-11066666.666666668,\"outstanding\":48400000},{\"month\":\"October\",\"payed\":0,\"principal\":48400000,\"principle_payment\":6666666.666666667,\"interest\":4840000,\"month_pay\":11506666.666666668,\"month_remain_balance\":-11506666.666666668,\"outstanding\":53240000},{\"month\":\"October\",\"payed\":0,\"principal\":53240000,\"principle_payment\":6666666.666666667,\"interest\":5324000,\"month_pay\":11990666.666666668,\"month_remain_balance\":-11990666.666666668,\"outstanding\":58564000},{\"month\":\"October\",\"payed\":0,\"principal\":58564000,\"principle_payment\":6666666.666666667,\"interest\":5856400,\"month_pay\":12523066.666666668,\"month_remain_balance\":-12523066.666666668,\"outstanding\":64420400},{\"month\":\"October\",\"payed\":0,\"principal\":64420400,\"principle_payment\":6666666.666666667,\"interest\":6442040,\"month_pay\":13108706.666666668,\"month_remain_balance\":-13108706.666666668,\"outstanding\":70862440}]', '2', '', '', '{\"user\":\"2\",\"action_time\":\"2018-10-24 15:20:34\",\"performed\":\"Created\"}'),
(4, 'LN10000005', 4, 'days', 1, 1, 'days', '  kkk k', '2018-10-24 12:21:41', 'NEW', 1, 1, 0, 0, '0000-00-00 00:00:00', '[{\"month\":\"October\",\"payed\":0,\"principal\":\"40000000\",\"principle_payment\":6666666.666666667,\"interest\":4000000,\"month_pay\":10666666.666666668,\"month_remain_balance\":-10666666.666666668,\"outstanding\":44000000},{\"month\":\"October\",\"payed\":0,\"principal\":44000000,\"principle_payment\":6666666.666666667,\"interest\":4400000,\"month_pay\":11066666.666666668,\"month_remain_balance\":-11066666.666666668,\"outstanding\":48400000},{\"month\":\"October\",\"payed\":0,\"principal\":48400000,\"principle_payment\":6666666.666666667,\"interest\":4840000,\"month_pay\":11506666.666666668,\"month_remain_balance\":-11506666.666666668,\"outstanding\":53240000},{\"month\":\"October\",\"payed\":0,\"principal\":53240000,\"principle_payment\":6666666.666666667,\"interest\":5324000,\"month_pay\":11990666.666666668,\"month_remain_balance\":-11990666.666666668,\"outstanding\":58564000},{\"month\":\"October\",\"payed\":0,\"principal\":58564000,\"principle_payment\":6666666.666666667,\"interest\":5856400,\"month_pay\":12523066.666666668,\"month_remain_balance\":-12523066.666666668,\"outstanding\":64420400},{\"month\":\"October\",\"payed\":0,\"principal\":64420400,\"principle_payment\":6666666.666666667,\"interest\":6442040,\"month_pay\":13108706.666666668,\"month_remain_balance\":-13108706.666666668,\"outstanding\":70862440}]', '2', '', '', '{\"user\":\"2\",\"action_time\":\"2018-10-24 15:21:41\",\"performed\":\"Created\"}'),
(5, 'LN10000006', 4, 'days', 1, 1, 'days', '  kkk k', '2018-10-24 12:25:46', 'NEW', 1, 1, 0, 0, '0000-00-00 00:00:00', '[{\"month\":\"October\",\"payed\":0,\"principal\":\"40000000\",\"principle_payment\":6666666.666666667,\"interest\":4000000,\"month_pay\":10666666.666666668,\"month_remain_balance\":-10666666.666666668,\"outstanding\":44000000},{\"month\":\"October\",\"payed\":0,\"principal\":44000000,\"principle_payment\":6666666.666666667,\"interest\":4400000,\"month_pay\":11066666.666666668,\"month_remain_balance\":-11066666.666666668,\"outstanding\":48400000},{\"month\":\"October\",\"payed\":0,\"principal\":48400000,\"principle_payment\":6666666.666666667,\"interest\":4840000,\"month_pay\":11506666.666666668,\"month_remain_balance\":-11506666.666666668,\"outstanding\":53240000},{\"month\":\"October\",\"payed\":0,\"principal\":53240000,\"principle_payment\":6666666.666666667,\"interest\":5324000,\"month_pay\":11990666.666666668,\"month_remain_balance\":-11990666.666666668,\"outstanding\":58564000},{\"month\":\"October\",\"payed\":0,\"principal\":58564000,\"principle_payment\":6666666.666666667,\"interest\":5856400,\"month_pay\":12523066.666666668,\"month_remain_balance\":-12523066.666666668,\"outstanding\":64420400},{\"month\":\"October\",\"payed\":0,\"principal\":64420400,\"principle_payment\":6666666.666666667,\"interest\":6442040,\"month_pay\":13108706.666666668,\"month_remain_balance\":-13108706.666666668,\"outstanding\":70862440}]', '2', '', '', '{\"user\":\"2\",\"action_time\":\"2018-10-24 15:25:46\",\"performed\":\"Created\"}'),
(6, 'LN10000007', 3, 'days', 1, 1, 'days', '  no description', '2018-10-24 12:46:34', 'NEW', 1, 1, 0, 0, '0000-00-00 00:00:00', '[{\"month\":\"October\",\"payed\":0,\"principal\":\"600000\",\"principle_payment\":200000,\"interest\":120000,\"month_pay\":320000,\"month_remain_balance\":-320000,\"outstanding\":720000},{\"month\":\"October\",\"payed\":0,\"principal\":720000,\"principle_payment\":200000,\"interest\":144000,\"month_pay\":344000,\"month_remain_balance\":-344000,\"outstanding\":864000},{\"month\":\"October\",\"payed\":0,\"principal\":864000,\"principle_payment\":200000,\"interest\":172800,\"month_pay\":372800,\"month_remain_balance\":-372800,\"outstanding\":1036800}]', '2', '', '', '{\"user\":\"2\",\"action_time\":\"2018-10-24 15:46:34\",\"performed\":\"Created\"}'),
(7, 'LN10000008', 3, 'days', 1, 1, 'days', '  jhjj', '2018-10-29 10:50:20', 'NEW', 1, 1, 0, 0, '0000-00-00 00:00:00', '[{\"month\":\"October\",\"payed\":0,\"principal\":\"600000\",\"principle_payment\":200000,\"interest\":120000,\"month_pay\":320000,\"month_remain_balance\":-320000,\"outstanding\":720000},{\"month\":\"October\",\"payed\":0,\"principal\":720000,\"principle_payment\":200000,\"interest\":144000,\"month_pay\":344000,\"month_remain_balance\":-344000,\"outstanding\":864000},{\"month\":\"October\",\"payed\":0,\"principal\":864000,\"principle_payment\":200000,\"interest\":172800,\"month_pay\":372800,\"month_remain_balance\":-372800,\"outstanding\":1036800}]', '2', '', '', '{\"user\":\"2\",\"action_time\":\"2018-10-29 13:50:20\",\"performed\":\"Created\"}'),
(8, 'LN10000009', 3, 'days', 1, 1, 'days', '  kmklnl', '2018-10-29 10:52:52', 'NEW', 1, 1, 0, 0, '0000-00-00 00:00:00', '[{\"month\":\"October\",\"payed\":0,\"principal\":\"600000\",\"principle_payment\":200000,\"interest\":60000,\"month_pay\":260000,\"month_remain_balance\":-260000,\"outstanding\":660000},{\"month\":\"October\",\"payed\":0,\"principal\":660000,\"principle_payment\":200000,\"interest\":66000,\"month_pay\":266000,\"month_remain_balance\":-266000,\"outstanding\":726000},{\"month\":\"October\",\"payed\":0,\"principal\":726000,\"principle_payment\":200000,\"interest\":72600,\"month_pay\":272600,\"month_remain_balance\":-272600,\"outstanding\":798600}]', '2', '', '', '{\"user\":\"2\",\"action_time\":\"2018-10-29 13:52:52\",\"performed\":\"Created\"}'),
(9, 'LN10000010', 3, 'days', 1, 1, 'days', '  kfvl dfkvf', '2018-10-29 12:03:42', 'NEW', 1, 1, 0, 0, '0000-00-00 00:00:00', '[{\"month\":\"October\",\"payed\":0,\"principal\":\"600000\",\"principle_payment\":200000,\"interest\":120000,\"month_pay\":320000,\"month_remain_balance\":-320000,\"outstanding\":400000},{\"month\":\"October\",\"payed\":0,\"principal\":400000,\"principle_payment\":200000,\"interest\":80000,\"month_pay\":280000,\"month_remain_balance\":-280000,\"outstanding\":200000},{\"month\":\"October\",\"payed\":0,\"principal\":200000,\"principle_payment\":200000,\"interest\":40000,\"month_pay\":240000,\"month_remain_balance\":-240000,\"outstanding\":0}]', '2', '', '', '{\"user\":\"2\",\"action_time\":\"2018-10-29 15:03:42\",\"performed\":\"Created\"}');
...
(11, 1, '2018-06-25', '2018-10-18', 'uinu', 'A4', '', 100);
...
--
-- Dumping data for table `sms_contact_group`
--

INSERT INTO `sms_contact_group` (`id`, `name`, `PIN`) VALUES
(1, 'Manager', 0);
...
--
-- Dumping data for table `sms_senderid`
--

INSERT INTO `sms_senderid` (`id`, `name`, `PIN`) VALUES
(1, 'HemediNey', 0);
...
INSERT INTO `user` (`id`, `namee`, `loan_no`) VALUES
(1, 'hemedi', ''),
(2, 'hemedi', 'LN10000002'),
(3, 'hemedi', 'LN10000003'),
(4, 'hemedi', 'LN10000004'),
...
(2, '127.0.0.1', 'info@tea.or.tz', '$2a$08$zCraEBXLmUDxbFl.lMXB0.0Tav2RAcnfAF7hsdYdcVKE/LXohG6iu', NULL, 'info@tea.or.tz', NULL, NULL, NULL, NULL, 1440340258, 1541166043, 1, 'Emmanuel', 'Shirima', 'TANZANIA EDUCATION AUTHORITY', '255712765538', '', '', '', 0, 0, 0, 1, 'client_account', 'S2000001', 100, 1),
...
--
-- Indexes for table `neymon_loan`
--
ALTER TABLE `neymon_loan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `neymon_loan_details`
--
ALTER TABLE `neymon_loan_details`
...
--
-- AUTO_INCREMENT for table `neymon_loan`
--
ALTER TABLE `neymon_loan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `neymon_loan_details`
--
ALTER TABLE `neymon_loan_details`
