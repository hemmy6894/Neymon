...
class Calculator extends CI_Controller {
    ...
    function index() {
        ...
        if ($this->input->post('base_amount')) {
            $_POST['base_amount'] = str_replace(',', '', $_POST['base_amount']);
        }
        ...
        $this->form_validation->set_rules('interest_rate', 'Interest Rate', 'required|integer');
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $return_data['interest_rate'] = $interest_rate;
