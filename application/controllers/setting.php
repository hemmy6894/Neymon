...
class Setting extends CI_Controller {
    ...
    function addloan_product($id = null) {
        ...
        $this->form_validation->set_rules('warning_day', lang('loanproduct_warning'), 'required|integer');
...
//  $this->form_validation->set_rules('loan_security_saving_minimum', lang('loanproduct_saving'), 'required|numeric');
        ...
        $this->form_validation->set_rules('loan_prepayment_account', lang('loanproduct_account_prepayment'), 'required');
        $this->form_validation->set_rules('loan_interest_receivable_account', lang('loanproduct_account_interest_receivable'), 'required');
...
//                'loan_security_contribution_times' => trim($this->input->post('loanproduct_contribution_times')),
                ...
                'warning_day' => trim($this->input->post('warning_day')),
                ...
                'loan_prepayment_account' => trim($this->input->post('loan_prepayment_account')),
                'loan_interest_receivable_account' => trim($this->input->post('loan_interest_receivable_account')),
        ...
        $this->data['account_list'] = $this->finance_model->account_chart_by_accounttype(array(10));
        $this->data['account_list2'] = $this->finance_model->account_chart_by_accounttype(array(40));
        $this->data['account_list3'] = $this->finance_model->account_chart_by_accounttype(array(10));
