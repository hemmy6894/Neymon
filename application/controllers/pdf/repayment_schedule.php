...
if($memberinfo->category == 'Company'){
    $html.='  <div style="border-bottom:1px solid #000; font-size:150px; font-weight:bold;">Basic Informations</div> <br/><table>
                <tr>
                    ...
                    <td valign="top"><div style="padding-left: 30px;">
                            ...
                            <strong>'.lang('companyname') .' : </strong> '.$memberinfo->firstname .'<br/>
                            <strong>'.lang('member_type_id_tin') .' : </strong> '.$memberinfo->TIN .'<br/>
                           <strong>'.lang('certificate_of_incorpation') .' : </strong> '.$memberinfo->incorporation_certificate.'<br/>
                           
                            <strong>'.lang('member_doi') .' : </strong> '.format_date($memberinfo->dob, FALSE) .'<br/>
...
$html.='  <td valign="top"><div>
                ...
                <td valign="top"><div style="padding-left: 40px;">
                        ...
                        <strong>' . lang('loan_amount_undisbursed') . ' </strong> ' . number_format($undisbursed_amount, 2) . '<br/>
                        <strong>' . lang('loan_amount_already_disbursed') . ' </strong> ' . number_format($disburseinfo->sumdisburseamount, 2) . '<br/>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: right;">' . number_format($loaninfo->total_loan, 2) . '   &nbsp;  &nbsp; </td>
            </tr>';
