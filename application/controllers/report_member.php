...
class Report_Member extends CI_Controller {
    ...
    function member_fields($column = null) {
        $colum_array = array(
            ...
            'members.type_id' => lang('member_type_id'),
            'members.type_id_number' => lang('member_type_id_number')
        );
        $colum_array1 = array(
    ...
    function member_list_print($link, $id = null) {
        ...
        $this->export_to_pdf($html, 'Client_List', $reportinfo->page);
    }
    ...
    function member_profile_print() {
        ...
        if ($member_id != '') {
            ...
            $this->export_to_pdf($html, 'Client_profile');
        }
    ...
    function export_to_pdf($html, $filename, $page_orientation = null) {
        ...
        $pdf->SetFooter('AFYA MICROFINANCE' . '|{PAGENO}|' . date('d-m-Y H:i:s')); // Add a footer for good measure <img src="https://davidsimpson.me/wp-includes/images/smilies/icon_wink.gif" alt=";)" class="wp-smiley">
