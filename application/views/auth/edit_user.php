<?php echo form_open(current_lang() . "/auth/edit_user/" . encode_id($user->id), 'class="form-horizontal"'); ?>
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('create_user_email_label'); ?>  : <span class="required">*</span> </label>
    <div class="col-lg-6">
        <input type="text" name="email" value="<?php echo set_value('email',$user->email); ?>"  class="form-control" disabled="disabled"/>
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('create_user_phone_label'); ?>  : <span class="required">*</span> </label>
    <div class="col-lg-6">
        <div class="input-group"><span class="input-group-addon" style="border: 0px; padding: 0px 5px 0px 0px; margin: 0px"> <select name="pre_phone" style="background: transparent; padding: 7px;  border:  1px solid #E5E6E7">
                    ...
                    <?php } ?>
                </select> </span> <input type="text" name="phone" value="<?php echo set_value('phone',$user->phone); ?>"  class="form-control"/> </div>
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('edit_group_name_label'); ?>  : <span class="required">*</span> </label>
    <div class="col-lg-6">
        <select name="groupname" class="form-control">
            ...
            <?php
            $selected = set_value('groupname',$currentGroups->id);
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('create_user_username_label'); ?>  : <span class="required">*</span> </label>
    <div class="col-lg-6">
        <input type="text" name="username" value="<?php echo set_value('username',$user->username); ?>"  class="form-control" disabled="disabled"/>
        <?php echo form_error('username'); ?>
    </div>
</div>

<div class="form-group"><label class="col-lg-3 control-label">Change Password  : <span class="required">*</span> </label>
    <div class="col-lg-6">
        <input type="checkbox" class="flat" name="change_password" id="myCheck" value="1">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-lg-6">
        <input class="btn btn-primary" value="<?php echo lang('edit_user_submit_btn'); ?>" type="submit"/>
    </div>
</div>
<?php echo form_close(); ?>
