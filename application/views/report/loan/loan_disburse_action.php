    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-lg-6">
                ...
                <label class="control-label"><?php echo lang('loan_startdisburse_date'); ?>  : <span class="required">*</span></label><br/>

            <div class="input-group date" id="datetimepicker2" >
                    <input type="text" name="disbursedate2" placeholder="<?php echo lang('hint_date'); ?>" value="<?php echo set_value('disbursedate2'); ?>"  data-date-format="DD-MM-YYYY" class="form-control"/> 
                    <span class="input-group-addon">
                        <span class="fa fa-calendar "></span>
                    </span>
                </div>
                <?php echo form_error('disbursedate2'); ?>
                <br/>
            
          <!-- <label class="control-label"><?php echo lang('grace_period'); ?>  : <span class="required">*</span></label>
           
           <input  type="text"  name="grace_period" value="<?php echo $loaninfo->grace_period; ?>"  class="form-control  amountformat" style="width: 200px"/> 
              
           <select name="grace_period_unit" class="form-control" style="width: 220px; margin-top: -35px; margin-left: 220px;">
        ...
        <?php echo form_error('grace_period_unit'); ?>
           ...
           <?php if($memberinfo->category == "Company"){ ?>
           <label class="control-label"><?php echo lang('loan_amount_todisburse'); ?>  : <span class="required">*</span></label>
           ...
           <label class="control-label" ><?php echo lang('loan_amount_todisburse'); ?>  : <span class="required">*</span></label>
                ...
                <input type="text"  name="amount" value="<?php echo set_value('amount', $loaninfo->basic_amount); ?>"  class="form-control  amountformat" readonly/> 
           ...
           <?php } ?>
                ...
                <label class="control-label"><?php echo 'Disburse From A/C'; ?>: <span class="required">*</span></label>

                <select name="loan_disburse_account" class="form-control">
                    <option value=""><?php echo lang('select_default_text'); ?></option>
                    <?php
                ...
                <?php echo form_error('loan_disburse_account'); ?>

                <br/>
                <label class="control-label"><?php echo 'Disburse To A/C'; ?>: <span class="required">*</span></label>

                <select name="loan_disburse_accountto" class="form-control">
                    <option value=""><?php echo lang('select_default_text'); ?></option>
                    <?php
                    $selected = set_value('loan_disburse_accountto');
                    foreach ($account_list3['toplevel'] as $key => $value) {
                        foreach ($account_list3['sublevel'][$key] as $key_sub => $value_sub) {
                            ?>
                            <optgroup style="padding-left: 10px;" label="<?php echo $value->name . ' - ' . $value_sub->name; ?>">
                                <?php foreach ($account_list3['account_list'][$key][$key_sub] as $key1 => $value1) { ?>
                                    <option <?php echo ($value1->account == $selected ? 'selected="selected"' : ''); ?> value="<?php echo $value1->account; ?>"><?php echo $value1->name; ?></option>
                                <?php } ?>
                            </optgroup>
                 ...
                 <?php echo form_error('loan_disburse_accountto'); ?>
       ...
       <label class="control-label"><?php echo lang('paymentmethod'); ?>  : <span class="required">*</span></label>
            
                <select name="paymenthod" id="paymenthod" class="form-control">
                    <option value=""><?php echo lang('select_default_text'); ?></option>
                    <?php
                     $paymenthod = $this->finance_model->paymentmenthod();
       ...
       <br/>
        ...
        <div id="chequenumber"><label class="control-label"><?php echo lang('cheque_no'); ?>  : <span class="required">*</span></label>
...
<?php if ($loaninfo->multiple_disburse_status != 2) { ?>
                    <br/>
...
<?php echo form_close(); ?>
            ...
            <div  class="col-lg-6">
               <?php  $undisbursed_amount = $loaninfo->basic_amount-$disburseinfo->sumdisburseamount;
               ...
               ?>
                ...
                foreach ($evaluation_histry as $key => $value) {
                    ...
                    <div style="border-bottom: 1px solid #ccc; margin-bottom: 20px;">
                        ...
                        <strong><?php echo lang('paymentmethod'); ?></strong> : <?php echo $value->paymethod; ?><br/>
                        <?php if($value->paymethod =='CHEQUE'){ ?>
                        <strong><?php echo lang('cheque_no'); ?></strong> : <?php echo $value->cheque_no; ?><br/>
                        <?php } ?>
                        <strong><?php echo lang('loan_comment'); ?></strong> : <?php echo $value->comment; ?><br/>
                        <strong><?php echo lang('loan_recorder'); ?></strong> : <?php echo $value->first_name . ' ' . $value->last_name . ' &nbsp; &nbsp; ' . $value->createdon; ?>
                    </div>
