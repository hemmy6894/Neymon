        ...
        <tbody>
            ...
            <tr>
                ...
                <td ><?php echo $value->name; ?></td>
                 ...
                 if($value->push_to_evaluation == 0){
                 ?>
                     
                 |<a onClick="return pushtoevaluation('<?php echo base_url().'index.php/'.current_lang() . "/loan/push_to_evaluation/".encode_id($value->LID) ?>','<?php echo $value->LID; ?>' ,'<?php echo '  '.$info->member_id.' : '.$info->firstname.' '.$info->middlename.' '.$info->lastname; ?>')" ><i class="fa fa-arrow-right"></i> <?php echo lang('button_pushtoevaluation'); ?> </a>
                 <?php } ?>
                 </td>
            </tr>
