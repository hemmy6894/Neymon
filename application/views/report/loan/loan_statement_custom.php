...
<div id="searchboxdata">
    <?php echo form_open_multipart(current_lang() . "/report_loan/loan_statement_custom", 'class="form-horizontal"'); ?>
...
if ($loan_id != '') {
 ...
 $this->load->view('report/loan/loan_statement_content_custom',$this->data);
}
?>
