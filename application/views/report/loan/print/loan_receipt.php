    ...
    <table id="receipt_after_title">
       <?php //$deposited_to = client_user_info($trans->FROM_TO_PIN, TRUE); ?>
        ...
        <tr>            
         ...
         <tr>            
            <td colspan="3">Address: <b style="border-bottom: 1px dotted #000; width: 83%; margin-top:-20px; margin-left: 100px; font-weight: bold;" > LOAN <?php //echo $this->loan_model->installment_affected($trans->receipt); ?></b>
             </td>
        </tr>
         <tr>            
        ...
        <tr>
            ...
            <td>
                <input  type="checkbox" name="modul" class="pure-input-1-2" value="1" placeholder="Group name" checked="true"> Loan
            </td>
            <td>
