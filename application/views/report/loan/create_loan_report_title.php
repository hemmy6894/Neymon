...
<?php } ?>
<div class="form-group"><label class="col-lg-3 control-label"><?php echo ($link_cat == 1 ? 'Loan applied From' : (($link_cat == 3 || $link_cat == 6 || $link_cat == 7 || $link_cat == 8) ? 'Loan Disbursed From':($link_cat == 2 ? 'Loan Disbursed Until' : 'From'))); ?>  : <span class="required">*</span></label>
    <div class=" col-lg-6">
...
if($link_cat == 7){
    ?>
 <div class="form-group"><label class="col-lg-3 control-label"><?php echo 'Days Interval'; ?>  : <span class="required">*</span></label>
        <div class="col-lg-6">
            <input type="text" name="custom" class="form-control" value="<?php echo (isset($reportinfo) ? $reportinfo->custom : 30); ?>"/>
            <?php echo form_error('custom'); ?>
        </div>
    </div>
<?php
