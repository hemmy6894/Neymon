...
<div id="searchboxdata">
    <?php echo form_open_multipart(current_lang() . "/report_loan/loan_account_statement", 'class="form-horizontal"'); ?>
...
if ($loan_id != '') {
 ...
 $this->load->view('report/loan/loan_account_statement_content',$this->data);
}
?>
