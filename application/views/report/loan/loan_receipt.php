    ...
    <table id="receipt_header">
        <tr>
            ...
            <td id="receipt_title" style="padding-left: auto; padding-right: auto">
              ...
              <td id="logo_receipt">
                  <b>NO.</b>  <div style ="font-size: 160%; padding-left: 0px"><?php echo $trans->customer_receipt; ?></div>
               </td>
        </tr>
    </table>
    ...
    <table id="receipt_after_title">
       <?php //$deposited_to = client_user_info($trans->FROM_TO_PIN, TRUE); ?>
        <tr>
            <td>&nbsp;</td>
             <td>&nbsp;</td>
            <td>Date  <div style="border-bottom: 1px dotted #000; width: 83%; margin-top:-20px; margin-left: 40px; font-weight: bold; "> <?php  echo format_date($trans->paydate, FALSE) ; ?></div></td>
            
        </tr>
        <tr>            
            <td colspan="3">Received from: <div style="border-bottom: 1px dotted #000; width: 83%; margin-top:-20px; margin-left: 100px; font-weight: bold;" > <?php $fullname = $this->loan_model->loan_holder_name($trans->LID); echo $trans->LID.' - '.$fullname ; ?>  </div> </td>
        </tr>
         <tr>            
            <td colspan="3">Address: <div style="border-bottom: 1px dotted #000; width: 83%; margin-top:-20px; margin-left: 100px; font-weight: bold;" > LOAN <?php //echo $this->loan_model->installment_affected($trans->receipt); ?></div>
                <!--</br> <div style="border-bottom: 1px dotted #000; width: 100%;  font-weight: bold;" > </div>
                </br> <div style="border-bottom: 1px dotted #000; width: 100%;  font-weight: bold;" ></div>-->
            </td>
        </tr>
         <tr>            
        ...
        <tr>
            ...
            <td>
                <input  type="checkbox" name="modul" class="pure-input-1-2" value="1" placeholder="Group name" checked> Loan Repayment
            </td>
            <td>
        ...
        <tr>            
            <td colspan="2">Amount <div style="border-bottom: 1px dotted #000; width: 73%; margin-top:-20px; margin-left: 60px; font-weight: bold;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo number_format($trans->amount,2) ; ?>  </div>  </td>
         ...
         <tr>            
            <td colspan="2">Signature <div style="border-bottom: 1px dotted #000; width: 73%; margin-top:-20px; margin-left: 60px; font-weight: bold;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </div>  </td>
            <td>&nbsp;</td>
        </tr>
...
<div style="margin: auto; text-align: center; margin-top: 20px;">
            <?php echo anchor(current_lang().'/loan/print_receipt/'.$trans->receipt,  lang('print_receipt'),'class="btn btn-primary"'); ?>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
