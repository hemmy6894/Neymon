    ...
    <div class="col-lg-12">
        <div style=" padding: 30px 10px; margin: auto;">
            <div style="text-align: center;"> <h3><strong><?php echo company_info()->name; ?></strong></h3>
                <h1><strong>Loan Repayment Transactions</strong></h1>
    ...
    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style=" text-align: left; width: 100px; ">Paid Date</th>      
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;"><?php echo $this->member_model->member_name(null,$loaninfo->PID) ?></td>
        ...
        <div style="text-align: center; padding-top: 20px; border-top: 1px solid #000;">
					<?php
						$data = site_url(current_lang() . '/report_loan/loan_transaction_print/' . $link_cat . '/' . $id); 
					?>
