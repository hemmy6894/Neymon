    ...
    <div class="col-lg-12">
        <div style=" padding: 30px 10px; margin: auto;">
            <div style="text-align: center;"> <h3><strong><?php echo company_info()->name; ?></strong></h3>
                <h1><strong>Member Shares Transactions</strong></h1>
                ...
                <div class="table-responsive" style="overflow: auto;">
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: right; width: 100px;">No. Of Share affected</th>  
                            </tr>
                 ...
                 <div style="text-align: center">
					<?php
						...
						$data = site_url(current_lang() . '/report_share/share_transaction_print/' . $link_cat . '/' . $id);
