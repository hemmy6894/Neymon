    ...
    <div class="col-lg-12">
        <div style=" padding: 30px 10px; margin: auto;">
            <div style="text-align: center;"> <h3><strong><?php echo company_info()->name; ?></strong></h3>
                <h1><strong>Member Contributions Transactions Summary</strong></h1>
            ...
            <div style="padding-top: 20px;">
                ...
                <div style="text-align: center">
                    <?php
						$data = site_url(current_lang() . '/report_contribution/contribution_transaction_summary_print/' . $link_cat . '/' . $id);
					?>
