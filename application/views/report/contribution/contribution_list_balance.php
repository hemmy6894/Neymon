        ...
        <div style=" padding: 30px 10px; margin: auto;">
            ...
            <div style="padding-top: 20px;">
                ...
                <div style="text-align: center">
					...
					<?php
						$data = site_url(current_lang() . '/report_contribution/contribution_balance_print/' . $link_cat . '/' . $id);
						$data1 = site_url(current_lang() . '/report_contribution/create_contribution_report_title/' . $link_cat . '/' . $id);
					?>
					 <a href="#" onclick="printJS('<?=$data;?>')" class="btn btn-primary">Print</a>
					 &nbsp; &nbsp; &nbsp; &nbsp;
					 <a href="<?=$data1;?>"  class="btn btn-primary">Edit</a>
