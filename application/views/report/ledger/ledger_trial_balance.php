    ...
    <div class="col-lg-12">
        <div style=" padding: 30px 10px; margin: auto;">
            <div style="text-align: center;"> <h3><strong><?php echo company_info()->name; ?></strong></h3>
                ...
                <h4><strong> For the period of  <?php echo format_date($reportinfo->fromdate, false); ?> To <?php echo format_date($reportinfo->todate, false) ?></strong></h4>
            </div>
            ...
            <div style="text-align: center">
				<?php
					$data = site_url(current_lang() . '/report/ledger_trial_balance_print/' . $link_cat . '/' . $id);
				?>
