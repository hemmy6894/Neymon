        ...
        <div style=" padding: 0px; margin: auto;">
            ...
            <div style="padding-top: 20px;">
                ...
                <table cellpadding="0" cellspacing="0" class="table" style="width: 100%;">
                    <thead>
                       <tr>
                            <th style="text-align: center; width: 300px; ">Account</th>
                            <th style="text-align: right;  width: 180px;"> Opening</th>
                            <th style="text-align: right;  width: 180px;"> Debit</th>
                            <th style="text-align: right;  width: 180px;"> Credit</th>
                            <th style="text-align: right;  width: 180px;"> Closing</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        foreach ($account_list['toplevel'] as $key => $value) {
                            foreach ($account_list['sublevel'][$key] as $key_sub => $value_sub) {
                                ...
                                foreach ($account_list['account_list'][$key][$key_sub] as $key1 => $value1) {
                                    $account_balance = $this->report_model->trial_balance_account($value1->account, $reportinfo->fromdate, $reportinfo->todate);
                                    ...
                                    $open_balance = $account_balance['balance'];
