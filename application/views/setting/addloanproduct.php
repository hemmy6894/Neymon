...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('loanproduct_warning'); ?>  : <span class="required">*</span></label>
    <div class="col-lg-6">
        <input type="text" name="warning_day"   value="<?php echo (isset($product) ? $product->warning_day : set_value('warning_day')); ?>"  class="form-control"/> 
        <?php echo form_error('warning_day'); ?>
    </div>
</div>
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('loanproduct_account_prepayment'); ?>  : <span class="required">*</span></label>
    <div class="col-lg-6">
        <select name="loan_prepayment_account" class="form-control">
            <option value=""><?php echo lang('select_default_text'); ?></option>
            <?php
            $selected = isset($product) ? $product->loan_prepayment_account : set_value('loan_prepayment_account');
            foreach ($account_list3 as $key => $value) {
                ?>
                <optgroup label="<?php echo $value['info']->name; ?>">
                    <?php foreach ($value['data'] as $key1 => $value1) { ?>
                        <option <?php echo ($value1->account == $selected ? 'selected="selected"' : ''); ?> value="<?php echo $value1->account; ?>"><?php echo $value1->name; ?></option>
        ...
        <?php echo form_error('loan_prepayment_account'); ?>
    </div>
</div>

<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('loanproduct_account_interest_receivable'); ?>  : <span class="required">*</span></label>
    <div class="col-lg-6">
        <select name="loan_interest_receivable_account" class="form-control">
            <option value=""><?php echo lang('select_default_text'); ?></option>
            <?php
            $selected = isset($product) ? $product->loan_interest_receivable_account : set_value('loan_interest_receivable_account');
            foreach ($account_list3 as $key => $value) {
                ?>
                <optgroup label="<?php echo $value['info']->name; ?>">
                    <?php foreach ($value['data'] as $key1 => $value1) { ?>
        ...
        <?php echo form_error('loan_interest_receivable_account'); ?>
    </div>
</div>
