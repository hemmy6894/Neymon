       ...
       <?php //$deposited_to = client_user_info($trans->FROM_TO_PIN, TRUE); ?>
        ...
        <tr>            
         ...
         <tr> 
             ...
             ?>
            <td colspan="3">Address: <div style="border-bottom: 1px dotted #000; width: 83%; margin-top:-20px; margin-left: 100px; font-weight: bold;" > <?php echo 'P.O.Box '.$contactinfo->postaladdress; ?></div>
