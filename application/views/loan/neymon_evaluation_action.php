...
<div class="col-lg-12">
        ...
        <div class="panel-body">
            <table>
                <tr>
                    ...
                    $interval = $this->setting_model->intervalinfo($loaninfo->loan_period)->row();
                    ?>
                    <td valign='top'><div style="padding-left: 30px;">
                            <strong><?php echo "";//lang('loan_product') ?> : </strong> <?php echo "";//$product->name; ?><br/>
                            <strong><?php echo lang('loanproduct_interest') ?> : </strong> <?php echo $loaninfo->loan_rate; ?><br/>
                            <strong><?php echo lang('loan_installment') ?> : </strong> <?php echo $loaninfo->loan_period . ' ' . $loaninfo->loan_period_mark; ?><br/>
                            <strong><?php echo lang('loan_paysource') ?> : </strong> <?php echo $loaninfo->account_type; ?><br/>

                        </div></td>
                    <td valign="top"><div style="padding-left: 40px;">
                            <strong><?php echo lang('loan_applicationdate') ?> : </strong> <?php echo format_date($loaninfo->loan_date, FALSE); ?><br/>
                            <strong><?php echo lang('loan_installment_amount') ?> : </strong> <?php echo number_format($loaninfo->loan_amount_total, 2); ?><br/>
                            <strong><?php echo lang('loan_total_interest') ?> : </strong> <?php echo number_format($loaninfo->loan_amount_rate, 2); ?><br/>
                            <strong><?php echo lang('loan_applied_amount') ?> : </strong> <?php echo number_format($loaninfo->loan_amount, 2); ?><br/>

                        </div></td>
                    <td valign="top"><div style="padding-left: 40px;">
                            <strong><?php echo lang('loan_LID') ?> : </strong> <?php echo $loaninfo->loan_id; ?><br/>
                             <strong><?php echo lang('loan_total') ?> : </strong> <?php echo number_format($loaninfo->loan_amount_total, 2); ?><br/>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table>
                <tr>
                    <?php
                    $businessinfo = $this->loan_model->get_loanbusinessinfo($loaninfo->loan_id);
                    ?>
                    <td valign='top'><div style="padding-left: 40px;">
    ...
    <!-- basic loan information -->
    <?php $declaration = $this->loan_model->get_declaration($loaninfo->loan_id); ?>
    <?php $supporting_doc = $this->loan_model->get_supporting_doc($loaninfo->loan_id); ?>
    <div class="panel panel-default">
        <div class="panel-heading">
        ...
        <div class="panel-body">
            <div class="col-lg-12">
               ...
               <div class="col-lg-12">
                ...
                <?php
                $guarantor_list = $this->loan_model->get_guarantor(null, $loaninfo->loan_id)->result();
 ...
 <?php
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div  class="col-lg-6">
                <?php
                $evaluation_histry = $this->loan_model->loan_evaluation_history($loaninfo->loan_id)->result();
