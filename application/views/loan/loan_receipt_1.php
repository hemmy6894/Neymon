...
<div id="receipt">
    ...
    <table id="receipt_after_title">
       <?php //$deposited_to = client_user_info($trans->FROM_TO_PIN, TRUE); ?>
        <tr>
            <td>Date/Tarehe <br/> <b> <?php  echo format_date($trans->paydate, FALSE) ; ?></b></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>Loan Number <br/>Namba ya Mkopo<br/><b> <?php echo $trans->LID ; ?></b></td>
            <td>Loan Holder's Name<br/>Jina la Mwenye Mkopo<br/><b>   <?php
            
          echo $this->loan_model->loan_holder_name($trans->LID);  ?></b></td>
        </tr>
        <tr>
            <td>Installment Affected<br/>&nbsp<br/><b> <?php echo $this->loan_model->installment_affected($trans->receipt); ?></b></td>
            <td>Amount<br/>Kiasi cha Fedha<br/><b>   <?php echo number_format($trans->amount,2);  ?></b></td>
        </tr>
        <tr>
            <td>Transaction Number <br/>Namba ya Muamala<br/><b> <?php echo $trans->customer_receipt; ?></b></td>
